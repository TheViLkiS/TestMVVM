...
extension TestView {
    ...
    func makeDescriptionLabel() -> UILabel {
        let descriptionalLabel = makeLabel(size: 14)
        descriptionalLabel.numberOfLines = 0
        descriptionalLabel.topAnchor.constraint(equalTo: titleLabel.bottomAnchor).isActive = true
        descriptionalLabel.centerXAnchor.constraint(equalTo: centerXAnchor).isActive = true
        return descriptionalLabel
    }
